...
// Сохранение состояния флажков в локальное хранилище
function saveCheckboxState() {
    var checkboxes = document.querySelectorAll('.filter-drawer input[type="checkbox"]');
    var state = {};
...
// Восстановление состояния флажков из локального хранилища
...
// Обработчик события клика по кнопке "Фильтровать"
$('.filter-submit').on('click', function () {
    saveCheckboxState();
    // Здесь добавьте код для отправки запроса с учетом выбранных фильтров
});
