# Generated by Django 4.2.6 on 2024-10-03 19:01
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('price_cart', models.DecimalField(decimal_places=2, default=0, max_digits=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(blank=True, default=None, help_text='Укажите статус', max_length=64, null=True, verbose_name='Статус')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('products', models.ManyToManyField(help_text='Выберите товар', to='products.product', verbose_name='Товар')),
